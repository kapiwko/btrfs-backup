...
action is a fail-closed 4.0 pre-upgrade gate; it is read-only and never edits
...
and requests installation of the latest 3.2.x bridge release. Legacy profiles
