...
class ScreenshotManager final : public QObject {
  ...
  public slots:
    ...
    QString ListProfiles() const {
        return QStringLiteral(R"([{"schemaVersion":1,"profileId":"home","name":"Home backup","enabled":true,"targetName":"Portable Backup","sources":[{"id":"documents","name":"Documents"}],"configurationValid":true,"configurationErrorCode":""},{"schemaVersion":1,"profileId":"archive","name":"Project archive","enabled":false,"targetName":"Studio Archive","sources":[{"id":"projects","name":"Projects"}],"configurationValid":true,"configurationErrorCode":""}])");
    }
    ...
    QString GetHistorySanitized(const QString& profile, uint, uint) const {
        ...
        return QStringLiteral(R"([{"schemaVersion":1,"state":"succeeded","errorCode":"","sourceName":"Documents","targetName":"Portable Backup","startedAt":"2026-09-02T21:08:54Z","finishedAt":"2026-09-02T21:32:54Z","sourceCount":2,"overallProgress":100,"bytesTransferred":68719476736},{"schemaVersion":1,"state":"succeeded","errorCode":"","sourceName":"Projects","targetName":"Portable Backup","startedAt":"2026-09-01T18:14:00Z","finishedAt":"2026-09-01T18:23:42Z","sourceCount":2,"overallProgress":100,"bytesTransferred":12884901888},{"schemaVersion":1,"state":"cancelled","errorCode":"operation.cancelled","sourceName":"Documents","targetName":"Portable Backup","startedAt":"2026-08-31T07:40:00Z","finishedAt":"2026-08-31T07:43:18Z","sourceCount":2,"overallProgress":37,"bytesTransferred":4294967296},{"schemaVersion":1,"state":"failed","errorCode":"target.unavailable","sourceName":"Documents","targetName":"Portable Backup","startedAt":"2026-08-30T20:50:00Z","finishedAt":"2026-08-30T20:50:08Z","sourceCount":2,"overallProgress":4,"bytesTransferred":0}])");
    }

    QString GetProfileDetails(const QString&) const {
        return QStringLiteral(R"({"schemaVersion":3,"profileId":"home","generation":"0123456789abcdef0123456789abcdef","fingerprint":"abcdef0123456789abcdef0123456789","configurationValid":true,"configurationErrorCode":"","sourceCandidates":[{"id":"source-home","path":"/home","displayName":"/home"},{"id":"source-projects","path":"/srv/projects","displayName":"/srv/projects"}],"document":{"schemaVersion":1,"profileId":"home","name":"Home backup","enabled":true,"target":{"device":"/dev/disk/by-uuid/11111111-2222-3333-4444-555555555555","luksUuid":"11111111-2222-3333-4444-555555555555","btrfsUuid":"66666666-7777-8888-9999-aaaaaaaaaaaa","partitionUuid":"aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee","serial":"Portable-Backup-001","mapperName":"backupdisk","activation":{"mode":"askPassword"}},"paths":{"remoteRoot":"/mnt/btrfs-backup/home/snapshots","incomingRoot":"/mnt/btrfs-backup/home/.incoming"},"settings":{"dailyLimit":false,"incrementalRequired":true,"keepFailedLocalSnapshot":false,"autoEject":true,"remoteRetention":30,"localRetention":30,"minimumTargetFreeBytes":5368709120,"minimumLocalFreeBytes":1073741824},"sources":[{"id":"documents","name":"Documents","enabled":true,"subvolume":"/home","localSnapshotDir":"/.snapshots/home","remoteSubdir":"home","remoteRetention":30,"localRetention":30}]}})");
    }
    ...
    QString BuildDevicePreparationPlan(const QString& request) const {
        ...
        const QString before = QStringLiteral(
                                   ...
                                   .arg(mode == QStringLiteral("reformat-existing-partition") ? QStringLiteral("true") : QStringLiteral("false"));
