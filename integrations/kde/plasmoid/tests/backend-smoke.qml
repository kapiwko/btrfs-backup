    ...
    Timer {
        ...
        onTriggered: {
            ...
            if (typeof status.managerConnected !== "boolean"
                    ...
                    || typeof status.run.speedText !== "string"
                    || typeof status.run.lastSuccessAt !== "string"
                    || typeof status.run.lastAttemptAt !== "string"
                    || typeof status.run.lastAttemptState !== "string"
                    ...
                    || typeof status.target.capacityText !== "string"
                    || typeof status.target.usedText !== "string"
                    || typeof status.target.availableText !== "string"
