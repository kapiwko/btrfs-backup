...
int resolve_backup_coverage_by_fd(sd_bus_message* message, void* userdata, sd_bus_error* error) noexcept {
    return static_cast<ManagerDbusObject*>(userdata)->browse_methods().resolve_backup_coverage_by_fd(message, error);
}
...
const sd_bus_vtable manager_vtable[] = {
    ...
    SD_BUS_METHOD(manager_protocol::method::resolve_backup_coverage_by_fd, "h", "s", resolve_backup_coverage_by_fd, SD_BUS_VTABLE_UNPRIVILEGED),
