...
inline constexpr int profile_details_schema_version = 3;
inline constexpr int profile_source_candidate_schema_version = 1;
inline constexpr int browse_session_schema_version = 1;
inline constexpr int browse_operation_schema_version = 1;
inline constexpr int browse_directory_schema_version = 1;
inline constexpr int browse_directory_page_schema_version = 1;
inline constexpr int browse_entry_schema_version = 1;
inline constexpr int browse_repository_schema_version = 1;
...
inline constexpr char register_profile_source_candidate[] = "RegisterProfileSourceCandidate";
...
inline constexpr char list_previous_versions[] = "ListPreviousVersions";
...
inline constexpr char resolve_backup_coverage_by_fd[] = "ResolveBackupCoverageByFd";
