...
void Fixture::create_documents() {
    ...
    write_file(root_ / "etc/profiles/default/profile.json", R"({"schemaVersion":1,"configurationGeneration":"0123456789abcdef0123456789abcdef","profileId":"default","name":"Default backup","enabled":true,"target":{"device":"/dev/null","luksUuid":"11111111-2222-3333-4444-555555555555","btrfsUuid":"66666666-7777-8888-9999-aaaaaaaaaaaa","mapperName":"backupdisk","activation":{"mode":"askPassword"}},"sources":[{"id":"home","name":"Home","enabled":true,"subvolume":"/home","localSnapshotDir":"/.snapshots/home","remoteSubdir":"home","remoteRetention":2,"localRetention":2}]})"
                                                            "\n");
}
