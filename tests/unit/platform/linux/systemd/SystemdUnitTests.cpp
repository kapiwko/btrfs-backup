...
void test_unit_file_follows_load_path_precedence() {
    ...
    auto located = btrfsbackup::platform::linux::systemd::locate_systemd_unit_file(unit_name, roots);
    ...
    located = btrfsbackup::platform::linux::systemd::locate_systemd_unit_file(unit_name, roots);
    test_helpers::expect_true(
    ...
    test_helpers::expect_true(
        "unsafe unit name",
        !btrfsbackup::platform::linux::systemd::locate_systemd_unit_file("../outside.service", roots).has_value(),
