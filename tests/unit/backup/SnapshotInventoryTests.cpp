...
void test_parse_snapshot_name() {
    std::optional<btrfsbackup::backup::SnapshotName> parsed =
        btrfsbackup::backup::parse_snapshot_name("home-2026-08-23T082504Z", btrfsbackup::SourceId{"home"});
    ...
    test_helpers::expect_true(
        "reject wrong source",
        !btrfsbackup::backup::parse_snapshot_name("root-2026-08-23T082504Z", btrfsbackup::SourceId{"home"}).has_value(),
        "snapshot for another source should be ignored"
    );
    test_helpers::expect_true(
        "reject bad timestamp",
        !btrfsbackup::backup::parse_snapshot_name("home-2026-08-23-082504", btrfsbackup::SourceId{"home"}).has_value(),
        "bad timestamp should be ignored"
    );
    test_helpers::expect_true(
        "reject zero sequence",
        !btrfsbackup::backup::parse_snapshot_name("home-2026-08-23T082504Z-00", btrfsbackup::SourceId{"home"}).has_value(),
...
void test_invalid_inputs() {
    test_helpers::expect_validation_error("invalid source id", [] { (void)btrfsbackup::backup::parse_snapshot_name("bad source-2026-08-23T082504Z", btrfsbackup::SourceId{"bad source"}); }, "sourceId contains unsupported characters");
