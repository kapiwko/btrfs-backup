...
assert_contains(
    "${compact_polkit_policy}"
    "<actionid=\"io.github.btrfsbackup.open-browse-session\"><description>Openaread-onlyBtrfsbackupbrowsingsession</description><message>Authenticationisrequiredtobrowsebackupcontents</message><defaults><allow_any>no</allow_any><allow_inactive>auth_admin</allow_inactive><allow_active>yes</allow_active></defaults></action>"
    "passwordless authorization for active repository browsing"
)
assert_unprivileged_method(
...
assert_unprivileged_method(
    list_browse_directory_page ListBrowseDirectoryPage sssu s
    "<methodname=\"ListBrowseDirectoryPage\"><argname=\"sessionId\"type=\"s\"direction=\"in\"/><argname=\"relativePath\"type=\"s\"direction=\"in\"/><argname=\"continuationToken\"type=\"s\"direction=\"in\"/><argname=\"limit\"type=\"u\"direction=\"in\"/><argname=\"payload\"type=\"s\"direction=\"out\"/></method>"
)
assert_unprivileged_method(
    list_previous_versions ListPreviousVersions sssssu s
    "<methodname=\"ListPreviousVersions\"><argname=\"sessionId\"type=\"s\"direction=\"in\"/><argname=\"profileId\"type=\"s\"direction=\"in\"/><argname=\"sourceId\"type=\"s\"direction=\"in\"/><argname=\"relativePath\"type=\"s\"direction=\"in\"/><argname=\"continuationToken\"type=\"s\"direction=\"in\"/><argname=\"limit\"type=\"u\"direction=\"in\"/><argname=\"payload\"type=\"s\"direction=\"out\"/></method>"
)
assert_unprivileged_method(
